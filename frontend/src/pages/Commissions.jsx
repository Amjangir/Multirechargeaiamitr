...
export default function Commissions() {
  ...
  const [f, setF] = useState({ scope: "role", role: "retailer", user_id: "", service: "", operator: "", rate: "2" });
      ...
      <div className="card-surface overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-white/5">
            {rules.length === 0 && (<tr><td colSpan="6" className="p-8 text-center text-slate-500">No custom rules. Default 2% applied.</td></tr>)}
            {rules.map((r) => {
